...
2. Complete el método __main__ de la clase CountMainThreads para que:
	...
	3. Ejecute y revise la salida por pantalla. 
		Se ejecutan los hilos pero en cada ejecucion se obtienen  resultados diferentes, y se ejecutan en ordenes diferentes
	4. Cambie el incio con 'start()' por 'run()'. Cómo cambia la salida?, por qué?.
		Al ejecutar con Run y no Start lo que paso es que se ejecutan en orden y hasta que no termino un hilo no comienza el siguiente es decir de una forma secuencial
